    ...
    <section class="container">
        ...
        <div class="row">
            <div class="col list-box">
                <form action="../../assets/action/editar-veiculo.php" method="POST">
                <input type="hidden" value="<?php echo $row['idveiculo'];?>" name="idveiculo">    
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>Marca/Modelo</label>
                            <input type="text" class="form-control" name="marca-modelo" value="<?php echo$row['marca'];?>" placeholder="Insira a marca e modelo do veículo" required />
                        </div>  
                        <div class="form-group col-md-6">
                            <label>Cor</label>
                             <input type="text" class="form-control" name="cor" value="<?php echo$row['cor'];?>" placeholder="Insira a cor do veículo" required />
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col text-center ">
                           ...
                           <a class="btn btn-danger" href="../visualizar/">Cancelar</a>
                        </div> 
                    </div>                                                               
                </form>
         </div>
